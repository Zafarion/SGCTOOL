...
public class Formulario extends JPanel {
    ...
    protected final static String nomesRotulos[] = {"ROM Directory", "TXT Directory"};
    ...
    public Formulario (int quantidade, int numero) {
        ...
        rotuloSuperior = new JLabel("Shadowgate [NES] Dumper/Inserter 1.0. Requires a ROM with NES header. Only tested with US version.");
